# Generated by Powerlevel10k configuration wizard on 2022-07-10 at 20:37 -05.
...
() {
 ...
 function prompt_kali() {
    # -t "%n@%m:%~%(!.#.$) "
    p10k segment -f 208 -i '🐉' 
}

typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(os_icon kali vcs newline prompt_char)
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIINS_CONTENT_EXPANSION='%n@%m:%~%(!.#.$) '
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIINS_CONTENT_EXPANSION='❌ %n@%m:%~%(!.#.$) '
